...
# ------------------------------------------------------------------------------
  ...
  # String to use when there is no card.  This is the same length string as the
  # strings generated by to_s
  BLANK_CARD_STRING = "     "

  BLANK_CARD_WITH_BRACES_STRING = "[   ]"

  # String to use for representing a hidden card.
  HIDDEN_CARD_STRING = "[###]"
...
# ------------------------------------------------------------------------------
  ...
  def self.card_to_s(c, always_show_braces=false)
    if c.nil?
      if always_show_braces
        Card::BLANK_CARD_WITH_BRACES_STRING
      else
        Card::BLANK_CARD_STRING
      end
    else
      c.to_s
    end
